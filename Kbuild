...
CONFIG_NVMEVIRT_CONZONE_DUAL := y
...
ccflags-$(CONFIG_NVMEVIRT_CONZONE_DUAL) += -DBASE_SSD=CONZONE_DUAL_PROTOTYPE
ccflags-$(CONFIG_NVMEVIRT_CONZONE_DUAL) += -Wno-implicit-fallthrough
nvmev-$(CONFIG_NVMEVIRT_CONZONE_DUAL) += ssd.o zns_ftl.o zns_read_write.o zms_read_write.o zns_mgmt_send.o zns_mgmt_recv.o channel_model.o conv_ftl.o simple_ftl.o pqueue/pqueue.o
