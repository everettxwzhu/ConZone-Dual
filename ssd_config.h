...
#define NS_CAPACITY_0 (DUAL_SLC_LOGICAL_CAPACITY)
#define NS_SSD_TYPE_1 SSD_TYPE_CONZONE_TLC
#define NS_CAPACITY_1 (DUAL_TLC_LOGICAL_CAPACITY)
#else
...
#define DUAL_TLC_CAPACITY                                                                 \
	((uint64_t)DUAL_TLC_INIT_BLKS * NAND_CHANNELS * LUNS_PER_NAND_CH * PLNS_PER_LUN * \
	 BLK_SIZE)
/*
 * Linux's stock NVMe ZNS driver requires reported zone size to be a power of
 * two. The zone capacity below remains the real media-backed writable size.
 */
#define DUAL_SLC_ZONE_CAPACITY (pSLC_BLK_SIZE * PLNS_PER_ZONE)
#define DUAL_TLC_ZONE_CAPACITY (BLK_SIZE * PLNS_PER_ZONE)
#define DUAL_SLC_ZONE_SIZE MB(256ULL)
#define DUAL_TLC_ZONE_SIZE GB(1ULL)
#define DUAL_SLC_NR_ZONES (DUAL_SLC_CAPACITY / DUAL_SLC_ZONE_CAPACITY)
#define DUAL_TLC_NR_ZONES (DUAL_TLC_CAPACITY / DUAL_TLC_ZONE_CAPACITY)
#define DUAL_SLC_LOGICAL_CAPACITY ((uint64_t)DUAL_SLC_NR_ZONES * DUAL_SLC_ZONE_SIZE)
#define DUAL_TLC_LOGICAL_CAPACITY ((uint64_t)DUAL_TLC_NR_ZONES * DUAL_TLC_ZONE_SIZE)
#define DUAL_TOTAL_CAPACITY (DUAL_SLC_LOGICAL_CAPACITY + DUAL_TLC_LOGICAL_CAPACITY)
